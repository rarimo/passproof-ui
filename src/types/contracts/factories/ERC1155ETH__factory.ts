...
import type { ERC1155ETH, ERC1155ETHInterface } from "../ERC1155ETH";
...
const _abi = [
  ...
  },
  {
    ...
    name: "mintWithSimpleRootTransition",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IRegistrationSMTReplicator",
        name: "",
        type: "address",
      },
    ],
...
export class ERC1155ETH__factory {
  static readonly abi = _abi;
  static createInterface(): ERC1155ETHInterface {
    return new utils.Interface(_abi) as ERC1155ETHInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ERC1155ETH {
    return new Contract(address, _abi, signerOrProvider) as ERC1155ETH;
  }
}
